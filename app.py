"""Streamlit UI for ResearchMind multi-agent pipeline.

This module provides a lightweight Streamlit frontend where users can
enter a research topic and run a four-step pipeline: search, read,
write, and critique. The UI is primarily decorative CSS + small helper
functions for rendering pipeline step cards and displaying results.
...
def step_card(num: str, title: str, state: str, desc: str = ""):
    """Render a pipeline step card in the Streamlit UI.

    Args:
        num: Display number for the step (e.g. "01").
        title: Short title for the step.
        state: One of 'waiting', 'running', or 'done' used to style the card.
        desc: Optional short description shown under the title.
    """
    status_map = {
